package com.muilat.android.wazo.views;
...
//                    if(TextUtils.equals(button.getText(), mCorrectAnswer)){
//                        button.setChecked(true);
//                        button.setHighlightColor(getResources().getColor(R.color.colorCorrect));
//                    }
//                }
